...
session_start();
           ...
           if($_SERVER["REQUEST_METHOD"] == "POST" ){  // isset($_POST["sub"])
            ...
            $sql = "SELECT HO_email FROM houseowner WHERE HO_email = '$Email'";
            ...
            if(($rowcount ==0) && ($password == $Confirmpassword)){
                ...
                $sql = "INSERT INTO houseowner (HO_first_name, HO_last_name, HO_email, HO_password, city) VALUES ('$First_name','$Last_name','$Email','$password','$city')";
                $sqlres=mysqli_query($conn, $sql);
            }
...
<body>
    ...
    <section class="main">
        ...
        <div class="signupower-box">
            <h1>Sign Up</h1>
            <h4>welcome Owner </h4>
            <h6><?php if($rowcount !=0){ echo "This Email is used already<br>Try another one";} ?>
            <?php if(($rowcount ==0) && ($password == $Confirmpassword)){
                echo "You have successfully signed up<br>";
                $gotologin = "<a href='log-in.php'>Log in.</a>";
                echo $gotologin;}
            ?></h6>
            ...
            <p><a class="back-sign" href="sign-up.html">Back</a></p>
          </div>
